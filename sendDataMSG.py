...
*{percentage_active_cases}* van het bevolking heeft op dit moment CoronaVirus.

*{percentage_total_cases}* van het bevolking is ooit getest met CoronaVirus.
